...
import { LayoutDashboard, Users, FolderKanban, CheckSquare, CalendarCheck, BarChart3, LogOut, User } from "lucide-react"
...
const navItems = [
  ...
  { href: "/manager/leave-approval", label: "Leave Approval", icon: CalendarCheck },
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-lg font-semibold text-foreground">Workforce360</span>
            </div>
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="ghost" className="flex items-center gap-2">
                  ...
                  <span className="hidden sm:inline text-sm font-medium">Sarah Johnson</span>
                </Button>
              </DropdownMenuTrigger>
