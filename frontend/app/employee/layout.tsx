...
import { LayoutDashboard, Calendar, FileText, CheckSquare, Clock, LogOut, User } from "lucide-react"
...
const navItems = [
  ...
  { href: "/employee/leave", label: "Apply for Leave", icon: Calendar },
  { href: "/employee/payslip", label: "View Payslip", icon: FileText },
